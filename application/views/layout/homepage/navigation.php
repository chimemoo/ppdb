	...
	<section class="main">
		<div class="container">
			...
			<div class="row">
			    ...
			    <div class="text-box col-md-5 aboutschool">
					...
					<div class="cycle-gallery">
						<div class="mask">
							<div class="slideset">
								<div class="slide">
									<div class="img-box">
										<div class="img-holder"><img src="<?php echo base_url(); ?>assets/homepage/images/user-01.jpg" height="85" width="85" alt=""></div>
								...
								<div class="slide">
									<div class="img-box">
										<div class="img-holder"><img src="<?php echo base_url(); ?>assets/homepage/images/user-02.jpg" height="85" width="85" alt=""></div>
										<div class="text-holder">
								...
								<div class="slide">
									<div class="img-box">
										<div class="img-holder"><img src="<?php echo base_url(); ?>assets/homepage/images/user-03.jpg" height="85" width="85" alt=""></div>
										<div class="text-holder">
